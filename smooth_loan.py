...
def certificate_over_model(model, model_fname, helper, N_m, sigma):
    ...
    for _ in range(0,N_m): # loop over the smoothed model
        ...
        if (_ == 0): # the first model :
            ...
            # One Smoothed Model Done in 1.180408239364624 sec.
            # test size is 79735
    ...
    pa_exp_poison, pb_exp_poison, is_acc_poison=None,None,None
...
if __name__ == '__main__':
    ...
    helper.params['poison_trigger_names']=training_params['poison_trigger_names']
    ...
    logger.info(helper.params['poison_delta'])

    helper.load_data(training_params)
    helper.create_model()
    # save parameters:
